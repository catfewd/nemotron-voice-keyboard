...
public class LiveSubtitleService extends Service {
    ...
    public static final String ACTION_START = "com.catfewd.nemotron.START_SUBTITLES";
    public static final String ACTION_STOP = "com.catfewd.nemotron.STOP_SUBTITLES";
